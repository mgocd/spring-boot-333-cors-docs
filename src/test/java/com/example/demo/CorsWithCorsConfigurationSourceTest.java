...
@SpringBootTest(webEnvironment = RANDOM_PORT, classes = {DemoApplication.class, CorsWithCorsConfigurationSourceTest.SecurityConfigWithHttpCors.class})
public class CorsWithCorsConfigurationSourceTest extends CorsAbstractTest {
